...
type 'a main = {
  program: 'a block ;
  subprograms: 'a sub list }
and 'a sub = {
  sub_subprogram: 'a sub_desc ;
  sub_loc: Location.t }
and 'a sub_desc =
...
and 'a subroutine =
  ...
  sub_decls: 'a decl list }
and 'a func =
  {
  func_name: string ;
  func_args: string list ;
  func_decls: 'a decl list }
and 'a block = {
  vardecls: 'a vardecl list ;
  decls: 'a decl list }
and 'a vardecl = {
  vardecl_desc: 'a vardecl_desc ;
...
and 'a dim_param =
  {
  dim_param_desc: 'a dim_param_desc ;
...
and 'a case =
  {
  case_option: 'a case_option list ;
...
and 'a select =
  ...
  select_loc: Location.t }[@@deriving sexp]